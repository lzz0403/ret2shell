...
<div class="flex-1 flex flex-row">
  {#if showSidebar}
    <div class="w-1/4 min-w-[400px] max-w-[512px] bg-base-100/40 backdrop-blur border-r border-r-base-content/5" />
  {:else}
    <RxButton
      size="lg"
  ...
  {#if toggleSidebar && !showSidebar}
    <div
      class="fixed w-full max-w-[400px] h-full backdrop-blur-xl bg-base-100/40 border-r border-r-base-content/5"
